// ==UserScript==
// @name         Test Script - GMforPDA Inline Only
...
((e, t, o, r, n, i) => {
    ...
    function y(e) { // <--- FUNCTION Y DEFINITION MOVED UP HERE
        const t = new r(),
            i = t.signal,
            s = new r(),
            a = s.signal,
    ...
    const w = { // <--- OBJECT W DEFINITION *AFTER* FUNCTION Y
        version: 2.2,
        info: s,
        addStyle: d,
        ...
        xmlHttpRequest: async (e) => {
            ...
            const { abortController: t, prom: o } = y(e); // <--- NOW CALLING y(e) *AFTER* ITS DEFINITION
...
(function() {
    ...
    $(document).ready(function() {
        $('div.content-title > h4').append('<span style="color: blue; margin-left: 10px;">GMforPDA Inlined (Test)</span>');
        ...
        // --- Direct defineProperty Test ---
        try {
            Object.defineProperty(window, 'testProperty', { value: 'testValue', writable: true });
            if (window.testProperty === 'testValue') {
                $('div.content-title > h4').append('<span style="color: darkgreen; margin-left: 10px;">defineProperty WORKS!</span>');
                delete window.testProperty; // Clean up
            } else {
                $('div.content-title > h4').append('<span style="color: orange; margin-left: 10px;">defineProperty FAILS VALUE CHECK!</span>');
            }
        } catch (definePropError) {
            $('div.content-title > h4').append('<span style="color: darkred; margin-left: 10px;">defineProperty THROWS ERROR!</span>');
            console.error("defineProperty Test Error:", definePropError); // Check console for details
        }
        // --- End defineProperty Test ---
    });
})();